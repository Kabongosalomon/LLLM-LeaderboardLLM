...
# LLLM_AUGMENTED_SUMMARIZED_WITH_ID_ZEROSHOT_TDMS_DROP_7
...
script_args.run_name = f"sft_augmented_summ_with_id_zeroshot_llama2_{script_args.size}_tdms_50_percent_seq_len_{script_args.seq_length}
...
# script_args.run_name = f"sft_augmented_summ_with_id_zeroshot_llama2_{script_args.size}_tdms_50_percent_long_seq_len_{script_args.seq_length}"
...
script_args.run_name = f"sft_augmented_summ_with_id_zeroshot_llama2_{script_args.size}_tdms_50_percent_docteat_seq_len_{script_args.seq_length}"
