...
script_args.size = "xl" # 3B

# script_args.dataset_name = "./data/LLLM_AUGMENTED_SUMMARIZED_ZEROSHOT_TDMS_50_PERCENT_DOCTEAT/fold1"

# script_args.dataset_name = "./data/LLLM_AUGMENTED_SUMMARIZED_ZEROSHOT_TDMS_ALL_TEMPLATE_DOCTEAT/fold1"
# script_args.output_dir = f"./model_ckpt/docteat_flan_t5_{script_args.size}_tdms_f1_all_templates_new_data"
# script_args.run_name = f"sft_docteat_flan_t5_{script_args.size}_tdms_f1_all_templates_new_data"

# script_args.dataset_name = "./data/LLLM_AUGMENTED_SUMMARIZED_ZEROSHOT_TDMS_NO_TEMPLATE_DOCTEAT/fold1"
# script_args.dataset_name = "./data/LEADERBOARDS_DOCTEAT_TDMS_NO_TEMPLATES_STRICT"
# script_args.output_dir = f"./model_ckpt/docteat_flan_t5_{script_args.size}_tdms_f1_no_templates_strict"
# script_args.run_name = f"sft_docteat_flan_t5_{script_args.size}_tdms_f1_no_templates_strict"
# script_args.seq_length = 512

script_args.dataset_name = "./data/LEADERBOARDS_DOCTEAT_TDMS_50_PERCENT_TEMPLATES"
script_args.output_dir = f"./model_ckpt/docteat_flan_t5_{script_args.size}_tdms_f1_50_percent_templates"
script_args.run_name = f"sft_docteat_flan_t5_{script_args.size}_tdms_f1_50_percent_templates"
script_args.seq_length = 512

# script_args.dataset_name = "./data/LLLM_AUGMENTED_SUMMARIZED_ZEROSHOT_TDMS_NO_TEMPLATE_DOCTEAT/fold1"
# # script_args.dataset_name = "./data/LEADERBOARDS_DOCTEAT_TDMS_NO_TEMPLATES_RELAX"
# script_args.output_dir = f"./model_ckpt/docteat_flan_t5_{script_args.size}_tdms_f1_no_templates_new_data"
# script_args.run_name = f"sft_docteat_flan_t5_{script_args.size}_tdms_f1_no_templates_new_data"
# script_args.seq_length = 512

# script_args.dataset_name = "./data/LLLM_AUGMENTED_SUMMARIZED_WITH_ID_ZEROSHOT_TDMS_50_PERCENT/fold1"
# script_args.output_dir = f"./model_ckpt/rec_flan_t5_{script_args.size}_tdms_f1_all_template_new_data"
# script_args.run_name = f"sft_rec_flan_t5_{script_args.size}_tdms_f1_all_template_new_data"
# script_args.seq_length = 512
...
script_args.max_source_length = script_args.seq_length
script_args.max_target_length = 512
script_args.label_pad_token_id = -100
script_args.pad_to_multiple_of = 8
script_args.model_max_length = script_args.seq_length
