...
script_args.test_ckpt = "checkpoint-38000" # "checkpoint-4000"
i = 1
...
script_args.run_name = f"eval_long_summ_mistralai_{script_args.size}_tdms_f1_all_template_seq_{script_args.seq_length}"
