...
script_args.dataset_name = "./data/LLLM_LONG_SUMMARIZED_TDMS_ALL_TEMPLATE/fold2"
script_args.output_dir = f"./model_ckpt/long_summ_llama2_{script_args.size}_tdms_f2_all_template_seq_len_{script_args.seq_length}"
script_args.run_name = f"sft_long_summ_llama2_{script_args.size}_tdms_f2_all_template_seq_len_{script_args.seq_length}"
